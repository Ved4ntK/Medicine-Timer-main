...
import com.Ved4ntK.Medicine-Timerapp.extension.toFormattedTimeString
import com.Ved4ntK.Medicine-Timerapp.feature.medicationdetail.viewmodel.MedicationDetailViewModel
...
fun MedicationDetailScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            val Medicine-TimerAndType = "${medication.dosage} ${
            stringResource(
                when (medication.type) {
                    MedicationType.TABLET -> R.string.tablet
                    MedicationType.CAPSULE -> R.string.capsule
